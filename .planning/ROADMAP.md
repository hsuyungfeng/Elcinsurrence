...
**Success Criteria** (what must be TRUE):
  ...
  3. 三聯（醫療院所存查／衛生福利部中央健康保險署存查／代付款清單）版式差異（**第二聯**（健保署存查聯）多出「中央健康保險署填列」核定/複核/初核/審查委員欄，留空供健保署複核）正確反映（2026-08-08 實測 30396_1 官方模板後，使用者裁示以官方模板第二聯為準，取代原 CONTEXT D-03「第三聯」敘述）
...
- [x] 11-03-PLAN.md — config/facility.json＋scripts/build_appeal_print.py CLI＋PHI 安全防線＋README＋全套件回歸（408 passed / 2 skipped）
